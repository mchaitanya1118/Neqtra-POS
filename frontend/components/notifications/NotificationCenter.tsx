            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-[340px] sm:w-[380px] bg-surface/95 backdrop-blur-xl border border-surface-light rounded-3xl shadow-2xl overflow-hidden z-[100] origin-top-right"
                    >
                        {/* Header */}
